...
//-----------------------------------------------
  ...
  //---SHOW mars DISCOVERY---
  if (Math.floor(this.caravan.distance) >= 800 && (this.caravan.distance) <= 801) {
  ...
  if(Math.floor(this.caravan.distance) >= 1400 && Math.floor((this.caravan.distance) <= 1402)) {
  ...
  if(Math.floor(this.caravan.distance) >= 2500 && Math.floor((this.caravan.distance) <= 2502)) {
    // OregonH.UI.showAttack('belt')
